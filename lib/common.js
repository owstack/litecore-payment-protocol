...
var varintBufNum = ltcLib.encoding.BufferWriter.varintBufNum;
...
PaymentProtocol.PAYMENT_REQUEST_CONTENT_TYPE = 'application/litecoin-paymentrequest';
PaymentProtocol.PAYMENT_CONTENT_TYPE = 'application/litecoin-payment';
PaymentProtocol.PAYMENT_ACK_CONTENT_TYPE = 'application/litecoin-paymentack';
...
function magicHash(str) {
  var magicBytes = new Buffer('Litecoin Signed Message:\n');
